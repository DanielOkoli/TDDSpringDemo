...
public class GreetingsServiceTest {
    ...
    public void whenGenderMaleReturnMrTest(){
        String salute = greetingsService.getGreetingsByGender("male");
    ...
    public void whenGenderFemaleReturnMrsTest(){
        String salute = greetingsService.getGreetingsByGender("female");
    ...
    public void whenGenderGarbageThrowExceptionTest(){
        String salute = greetingsService.getGreetingsByGender("sdfsd");
    }
